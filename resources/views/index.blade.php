...
<html lang="en">
<head>
    <title>KINGDOM BOOKS & STATIONERY</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="KBS project">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+233552593633</div>
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="">info@ishopgh.com</a></div>
                        <div class="top_bar_content ml-auto">
                            <div class="top_bar_menu">
                                <ul class="standard_dropdown top_bar_dropdown">
                                    ...
                                    <li>
                                        <a href="#">GH CEDI<i class="fas fa-chevron-down"></i></a>
                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="cart_content">
                                        ...
                                        <div class="cart_price">GHC85</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cat_menu_container">
                                ...
                                <ul class="cat_menu">
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            <li class="hassubs">
                                                <a href="#">Desktop Computers<i class="fas fa-chevron-right"></i></a>
                                                <ul>
                                                    <li><a href="#">Monitors<i class="fas fa-chevron-right"></i></a></li>
                                                    <li><a href="#">Speakers<i class="fas fa-chevron-right"></i></a></li>
                                                    <li><a href="#">System Unit<i class="fas fa-chevron-right"></i></a></li>
                                                    <li><a href="#">Mouse<i class="fas fa-chevron-right"></i></a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Printers<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Scanners<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">UPS<i class="fas fa-chevron-right"></i></a></li>
                                        </ul>
                                    </li>
                            ...
                            <div class="main_nav_menu ml-auto">
                                <ul class="standard_dropdown main_nav_dropdown">
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#">Phone Deals<i class="fas fa-chevron-down"></i></a>
                                                <ul>
                                                    <li><a href="#">Apple Deals<i class="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Huawei Deals<i class="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Samsung Deals<i class="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Nokia Deals<i class="fas fa-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Laptop Deals<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="#">Game Console Deals<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="#">Accessories Deals<i class="fas fa-chevron-down"></i></a></li>
                                        </ul>
                                    </li>
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    <li><a href="#">iPhones<i class="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">iPads<i class="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Airpods<i class="fas fa-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Samsung<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="#">Huawei<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="#">Nokia<i class="fas fa-chevron-down"></i></a></li>
                                        </ul>
                                    </li>
                                    <li class="hassubs">
                        ...
                        <div class="page_menu_content">
                            ...
                            <ul class="page_menu_nav">
                                ...
                                <li class="page_menu_item has-children">
                                    ...
                                    <ul class="page_menu_selection">
                                        <li><a href="#">GH Cedi<i class="fa fa-angle-down"></i></a></li>
                                        a></li>
                                        ></li>
                                    </ul>
                                </li>
                            ...
                            <div class="menu_contact">
                                <div class="menu_contact_item"><div class="menu_contact_icon"><img src="images/phone_white.png" alt=""></div>+233501401050</div>
                                <div class="menu_contact_item"><div class="menu_contact_icon"><img src="images/mail_white.png" alt=""></div><a href="mailto:info@kingdomgh.com">info@kingdomgh.com</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row fill_height">
                ...
                <div class="col-lg-5 offset-lg-4 fill_height">
                    <div class="banner_content">
                        <h1 class="banner_text">new era of online shopping</h1>
                        <div class="banner_price"><span>GHC530</span>GHC460</div>
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    ...
                    <div class="char_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="char_content">
                            ...
                            <div class="char_subtitle">from GHC500</div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                <div class="owl-item deals_item">
                                    ...
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            ...
                                            <div class="deals_item_price_a ml-auto">GHC600</div>
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">Beoplay H7</div>
                                            <div class="deals_item_price ml-auto">GHC1225</div>
                                        </div>
                                        <div class="available">
                                ...
                                <div class="owl-item deals_item">
                                    ...
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"><a href="#">Headphones</a></div>
                                            <div class="deals_item_price_a ml-auto">GHC2300</div>
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">Beoplay H7</div>
                                            <div class="deals_item_price ml-auto">GHC1225</div>
                                ...
                                <div class="featured_slider slider">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                <div class="product_price discount">GHC1225<span>GHC2300</span></div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                <div class="product_price">GHC2559</div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                <div class="product_price">GHC1225</div>
                                ...
                                <div class="featured_slider slider">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/featured_1.png" alt=""></div>
                                            <div class="product_content">
                                                <div class="product_price discount">GHC1225<span>GHC600</span></div>
                                                <div class="product_name"><div><a href="product.html">Huawei MediaPad...</a></div></div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                                                        <input type="radio" checked name="product_color" style="background:#b19c83">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                <div class="product_price">GHC1225</div>
                                                <div class="product_name"><div><a href="product.html">Apple iPhone 7</a></div></div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                                                        <input type="radio" checked name="product_color" style="background:#b19c83">
                                                        <input type="radio" name="product_color" style="background:#000000">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                <div class="product_price">GHC2559</div>
                                                <div class="product_name"><div><a href="product.html">Samsung GALAXY S9...</a></div></div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                                                        <input type="radio" checked name="product_color" style="background:#b19c83">
                                                        <input type="radio" name="product_color" style="background:#000000">
                                    ...
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="arrivals_single_content">
                                            ...
                                            <div class="arrivals_single_name_container clearfix">
                                                ...
                                                <div class="arrivals_single_price text-right">GHC2559</div>
                                            </div>
                                ...
                                <div class="bestsellers_item discount">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        ...
                                        <div class="bestsellers_content">
                                            ...
                                            <div class="bestsellers_price discount">GHC1225<span>GHC600</span></div>
                                        </div>
                                    </div>
                                ...
                                <div class="trends_item is_new">
                                    ...
                                    <div class="trends_content">
                                        ...
                                        <div class="trends_info clearfix">
                                            ...
                                            <div class="trends_price">GHC2559</div>
                                        </div>
                                    </div>
                        ...
                        <div class="owl-carousel owl-theme viewed_slider">
                            ...
                            <div class="owl-item">
                                <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    ...
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">GHC1225<span>GHC600</span></div>
                            ...
                            <div class="owl-item">
                                <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    ...
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">GHC2559</div>
                            ...
                            <div class="owl-item">
                                <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    ...
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">GHC1225</div>
                            ...
                            <div class="owl-item">
                                <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    ...
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">GHC375</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_col">
                    <div class="footer_column footer_contact">
                        <div class="logo_container">
                            <div class="logo"><a href="#">KINGDOM BOOKS & STATIONERY</a></div>
                        </div>
                        <div class="footer_title">Got Question? Call Us 24/7</div>
                        <div class="footer_phone">+233501401050</div>
                        <div class="footer_contact_text">
                            <p>Awiikoona St. Coco Beach, Nungua</p>
                            <p>Accra, Ghana</p>
                        </div>
